...
if (isset($_POST['submit'])) {
  ...
  try {
    ...
    $consultaSQL = "INSERT INTO alumnos (nombre, apellido, email, cced, praca)";
...
<div class="container">
  <div class="row">
    <div class="col-md-12">
      <h2 class="mt-4">Creación de Estudiantes</h2>
      <hr>
      <form method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" name="praca" id="praca" class="form-control">
          </div>
        <div class="form-group">
